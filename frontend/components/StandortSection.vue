<template>
    <div class="bg-white grid px-8 py-20 lg:grid-cols-2 lg:px-40 md:px-20 lg:gap-x-32">
        <img :src="`${baseURL}${standortData?.attributes.locationimage.data?.attributes.formats.medium.url}`" alt="" class="order-2 pb-8 lg:col-span-1 lg:row-span-5 lg:order-1 md:w-60 lg:w-full md:mx-auto lg:mx-0">

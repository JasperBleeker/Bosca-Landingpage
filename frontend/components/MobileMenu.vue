<template>
    <nav class="fixed inset-0 z-50 flex items-center justify-center bg-moss">
      <button class="absolute p-1 right-4 top-8" title="close" @click="closeMenu">
  ...
  // Watch for route changes and close the menu automatically
  watch(route, () => {
    closeMenu();
  });
  </script>
